...
pub fn default_config() -> VestConfig {
    VestConfig {
        ...
        scanner: config::ScannerConfig {
            memory: config::ScannerModuleConfig { enabled: true },
            binary: config::ScannerModuleConfig { enabled: true },
            web: config::ScannerModuleConfig { enabled: true },
            browser: config::ScannerModuleConfig { enabled: true },
            network: config::ScannerModuleConfig { enabled: true },
            files: config::ScannerModuleConfig { enabled: true },
        },
